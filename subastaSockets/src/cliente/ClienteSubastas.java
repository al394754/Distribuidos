...
public class ClienteSubastas {
	...
	public static void main(String[] args) throws IOException  {
		...
		AuxiliarClienteSubastas gestorAuxiliarCliente = new AuxiliarClienteSubastas("localhost", "12345");
		...
		do {
			...
			case 0: // Cierra el gestor y sale del programa
				...
				gestorAuxiliarCliente.cierraGestor();
			...
			case 1: { // Consultar articulos de un tipo		
				...
				Vector<String> articulosDeUnTipo = gestorAuxiliarCliente.consultaTipo(tipo);
				if(articulosDeUnTipo.size() == 0) {
					System.out.print("[]");
					break;
				}
				String cantidad = articulosDeUnTipo.remove(0);
			...
			case 2: { // Consultar mis pujas		
				...
				Vector<String> todasLasPujas = gestorAuxiliarCliente.consultaPujas(codcli);
			...
			case 3: { // Poner en venta		
				...
				String articulo = gestorAuxiliarCliente.poneEnVenta(codcli, tipo, descrip, precio);
				if(articulo.equals(""))
			...
			case 4: { // Pujar			
				...
				String resultado = gestorAuxiliarCliente.puja(codcli, articulo, puja);
				if(resultado.equals("")) {
			...
			case 5: { // Vender		
				...
				String articulo = teclado.next();
				String resultado = gestorAuxiliarCliente.vende(codcli, articulo);
				if(resultado.equals("")) {
					System.out.println("Operación no realizada");
